...
class Field {
    ...
    void update_host() {
        ...
        cudaMemcpy(host_ptr_, device_ptr_, x_dim_ * y_dim_ * sizeof(double), cudaMemcpyDeviceToHost);
    }

    void update_device() {
        // TODO: copy contents of host_ptr_ to device_ptr_ 
        cudaMemcpy(device_ptr_, host_ptr_,  x_dim_ * y_dim * sizeof(double), cudaMemcpyHostToDevice);
    }
